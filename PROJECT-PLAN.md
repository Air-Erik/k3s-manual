...
- **AI задание:** ✅ `research/vm-template-prep/AI-AGENT-TASK.md` (создано)
...
- **Артефакты:**
  ...
  - [ ] Скрипт `scripts/prepare-vm-template.sh`
...
🚀 Этап  0: Подготовка               [████░░░░░░░░░░░░░░░░]  20% (AI задание создано)
...
### Для Team Lead:
**✅ ВЫПОЛНЕНО:** Задание для AI-агента создано!
- ✅ `research/vm-template-prep/AI-AGENT-TASK.md`

**Ожидаю:** Результаты от оператора после работы с AI-агентом

### Для оператора:
**→ ДЕЙСТВУЙТЕ СЕЙЧАС:** Работайте с AI-агентом ⬅️

**Инструкции:**
1. Откройте новый чат с AI-агентом (ChatGPT, Claude, Cursor, etc.)
2. Прикрепите файлы:
   - `README.md`
   - `nsx-configs/segments.md`
   - `research/vm-template-prep/AI-AGENT-TASK.md`
3. Используйте промпт из задания (см. раздел "Порядок работы с оператором")
4. Создавайте артефакты последовательно
5. Сохраняйте в репозиторий
6. Применяйте на vSphere
7. **Сообщите Team Lead о результатах**
